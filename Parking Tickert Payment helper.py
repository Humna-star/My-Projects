...
print("Accepted coins: 100, 200, 300, 500\n")
...
while True:
    coin = int(input("Insert a coin (100, 200, 300, or 500): "))
 
    # PART 4: Reject any coin that isn't a valid value
    if coin != 100 and coin != 200 and coin != 300 and coin != 500:
...
print("Made by Humna Arsalan Khan")